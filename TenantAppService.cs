...
using eInspection.Authorization.Roles;
using eInspection.Editions;
using eInspection.MultiTenancy.Dto;
using eInspection.Users;

namespace eInspection.MultiTenancy
{
    [AbpAuthorize(PermissionNames.Pages_Tenants)]
    public class TenantAppService : eInspectionAppServiceBase, ITenantAppService
    {
        ...
        {
            var list = new ListResultOutput<TenantListDto>(
